...
let Uname = document.getElementById('join_name');
let pass = document.getElementById('join_ps');
let passCH = document.getElementById('join_psCH'); //passCH -> 비밀번호 재확인
let address1 = document.getElementById('join_addre1'); //addre1 -> address (집주소)
let address2 = document.getElementById('join_addre2'); // addre2 -> address(상세주소)
...
function checkId(){  
  if(id.value.length < 6 || id.value.length >13){
    alert("아아디는 6~12 자리 사이로 입력해 주세요");
    id.focus();
  }
}
